...
HelloRequest::_table_ = {
  {
    ...
    // string req = 1;
    {PROTOBUF_FIELD_OFFSET(HelloRequest, _impl_.req_), _Internal::kHasBitsOffset + 0, 0,
...
PROTOBUF_NDEBUG_INLINE HelloResponse::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::hello::HelloResponse& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
...
HelloResponse::_table_ = {
  {
    ...
    // string rsp = 1;
    {PROTOBUF_FIELD_OFFSET(HelloResponse, _impl_.rsp_), _Internal::kHasBitsOffset + 0, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
