...
const ::uint32_t
    TableStruct_person_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::person::data::Person, _impl_._has_bits_),
        6, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::person::data::Person, _impl_.name_),
        PROTOBUF_FIELD_OFFSET(::person::data::Person, _impl_.id_),
        PROTOBUF_FIELD_OFFSET(::person::data::Person, _impl_.email_),
        0,
        2,
        1,
};
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::person::data::Person)},
};
static const ::_pb::Message* PROTOBUF_NONNULL const file_default_instances[] = {
    &::person::data::_Person_default_instance_._instance,
};
const char descriptor_table_protodef_person_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\014person.proto\022\013person.data\"1\n\006Person\022\014\n"
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:person.data.Person)
}
PROTOBUF_NDEBUG_INLINE Person::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::person::data::Person& from_msg)
...
Person::Person(
  ...
  // @@protoc_insertion_point(copy_constructor:person.data.Person)
}
PROTOBUF_NDEBUG_INLINE Person::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
Person::~Person() {
  // @@protoc_insertion_point(destructor:person.data.Person)
  SharedDtor(*this);
}
...
Person::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::person::data::Person>(),  // to_prefetch
...
// @@protoc_insertion_point(message_clear_start:person.data.Person)
...
::uint8_t* PROTOBUF_NONNULL Person::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(serialize_to_array_start:person.data.Person)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001u) != 0) {
    if (!this_._internal_name().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "person.data.Person.name");
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000002u) != 0) {
    if (!this_._internal_email().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "person.data.Person.email");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:person.data.Person)
  return target;
}
...
::size_t Person::ByteSizeLong() const {
  const Person& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:person.data.Person)
  ::size_t total_size = 0;
...
void Person::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:person.data.Person)
...
// @@protoc_insertion_point(class_specific_copy_from_start:person.data.Person)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
