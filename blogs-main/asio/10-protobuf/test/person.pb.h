...
/* @@protoc_insertion_point(class_definition:person.Person) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "person.Person"; }
 ...
 public:
  ...
  ::std::string* PROTOBUF_NONNULL mutable_sex();
  [[nodiscard]] ::std::string* PROTOBUF_NULLABLE release_sex();
  void set_allocated_sex(::std::string* PROTOBUF_NULLABLE value);

  private:
  const ::std::string& _internal_sex() const;
  PROTOBUF_ALWAYS_INLINE void _internal_set_sex(const ::std::string& value);
  ::std::string* PROTOBUF_NONNULL _internal_mutable_sex();
...
template <typename Arg_, typename... Args_>
PROTOBUF_ALWAYS_INLINE void Person::set_sex(Arg_&& arg, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.sex_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:person.Person.sex)
}
inline ::std::string* PROTOBUF_NONNULL Person::mutable_sex()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::std::string* _s = _internal_mutable_sex();
  // @@protoc_insertion_point(field_mutable:person.Person.sex)
  return _s;
}
...
inline ::std::string* PROTOBUF_NONNULL Person::_internal_mutable_sex() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000002u;
  return _impl_.sex_.Mutable( GetArena());
}
inline ::std::string* PROTOBUF_NULLABLE Person::release_sex() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:person.Person.sex)
...
inline void Person::set_allocated_sex(::std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000002u;
  } else {
  ...
  // @@protoc_insertion_point(field_set_allocated:person.Person.sex)
}
